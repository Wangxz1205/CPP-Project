...
---
以下分别测试了 $16\times16,\ 128\times128,\ 1k\times1k,\ 8k\times8k$ 时的运行时间，64k 因为太大，内存不够所以没有进行测试,但是可以根据时间复杂度来估算计算时长。
****         | $16\times16$ | $128\times128$ | $1k\times1k$ | $8k\times8k$ | $64k\times64k$
:------------:|:------------:|:--------------:|:----------------:|:----------------|:----------------:
 **plain**    |  0.000022s |     0.010612s  |      5.272622s    |      ~45min    |   384h       
 **SIMD**     | 0.000005s    |    0.000391s   |   0.096695s     |  106.455070s    |   15.14h
 **OpenMP**   |  0.000004s    |   0.001321s    |   0.108397s     |  106.240791s     | 15.11h
 **OpenBLAS** | 0.000014s    |    0.001428s    |  0.079011s      |  2.802694s  |    23.91min
